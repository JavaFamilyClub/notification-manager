 ...
 */
public class FeiShuJavaFamilyCachePropertiesCustomizer implements CachePropertiesCustomizer {

    private final FeiShuProperties properties;

    public FeiShuJavaFamilyCachePropertiesCustomizer(FeiShuProperties properties) {
